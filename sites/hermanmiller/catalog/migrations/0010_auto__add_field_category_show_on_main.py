...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.show_on_main'
        db.add_column(u'catalog_category', 'show_on_main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.show_on_main'
        db.delete_column(u'catalog_category', 'show_on_main')
    ...
    models = {
        ...
        u'catalog.productreview': {
            'Meta': {'ordering': "['-created_on']", 'object_name': 'ProductReview'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'author': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reviews'", 'to': u"orm['catalog.Product']"}),
