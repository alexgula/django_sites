...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalog_category', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Category.meta_keywords'
        db.add_column(u'catalog_category', 'meta_keywords',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'catalog_category', 'meta_description')

        # Deleting field 'Category.meta_keywords'
        db.delete_column(u'catalog_category', 'meta_keywords')
