...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductReview.email'
        db.add_column(u'catalog_productreview', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductReview.email'
        db.delete_column(u'catalog_productreview', 'email')
