...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'shop_customer', ['name'])


        # Changing field 'Order.customer'
        db.alter_column(u'shop_order', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Customer'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.customer'
        db.alter_column(u'shop_order', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Customer']))
        # Adding unique constraint on 'Customer', fields ['name']
        db.create_unique(u'shop_customer', ['name'])
