...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.sum_uah'
        db.alter_column(u'shop_order', 'sum_uah', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

        # Changing field 'Order.sum_eur'
        db.alter_column(u'shop_order', 'sum_eur', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Order.sum_uah'
        db.alter_column(u'shop_order', 'sum_uah', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=4))

        # Changing field 'Order.sum_eur'
        db.alter_column(u'shop_order', 'sum_eur', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=4))
    ...
    models = {
        ...
        u'shop.order': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'liqpay_phone': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'liqpay_status': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'liqpay_transaction_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
