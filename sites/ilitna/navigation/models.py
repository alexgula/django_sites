...
class Trail(object):
    ...
    def append_node(self, obj):
        ...
        node = ModelNode(obj) if isinstance(obj, models.Model) else obj
...
try:
    ...
    class MPTTTrail(Trail):
        """Special case trail - if we don't want to add every ancestor to breadcrumbs, but menu activity should
        check every ancestor of a node, then use this."""
