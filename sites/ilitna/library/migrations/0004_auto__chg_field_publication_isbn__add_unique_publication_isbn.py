...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('library_publication', 'isbn', self.gf('django.db.models.fields.CharField')(unique=True, max_length=13))

    def backwards(self, orm):
        # Removing unique constraint on 'Publication', fields ['isbn']
        db.delete_unique('library_publication', ['isbn'])


        # Changing field 'Publication.isbn'
        db.alter_column('library_publication', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=17))
    models = {
        'library.author': {
