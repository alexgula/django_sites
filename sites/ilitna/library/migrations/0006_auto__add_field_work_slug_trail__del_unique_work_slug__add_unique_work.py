...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Work.slug_trail'
        db.add_column('library_work', 'slug_trail',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Work', fields ['slug', 'parent']
        db.create_unique('library_work', ['slug', 'parent_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Work', fields ['slug', 'parent']
        db.delete_unique('library_work', ['slug', 'parent_id'])

        # Deleting field 'Work.slug_trail'
        db.delete_column('library_work', 'slug_trail')
    ...
    models = {
        ...
        'library.work': {
            'Meta': {'unique_together': "(('slug', 'parent'),)", 'object_name': 'Work'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'slug_trail': ('django.db.models.fields.SlugField', [], {'max_length': '250', 'blank': 'True'}),
        ...
        'library.workimage': {
            ...
            'position': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10'}),
