...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceType.parent'
        db.add_column('places_placetype', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['places.PlaceType']), keep_default=False)

        # Adding field 'PlaceType.active'
        db.add_column('places_placetype', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'PlaceType.code'
        db.add_column('places_placetype', 'code', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'PlaceType.parent'
        db.delete_column('places_placetype', 'parent_id')

        # Deleting field 'PlaceType.active'
        db.delete_column('places_placetype', 'active')

        # Deleting field 'PlaceType.code'
        db.delete_column('places_placetype', 'code')
