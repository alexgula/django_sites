...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('places_place', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['places.PlaceType']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Place.type'
        db.delete_column('places_place', 'type_id')
