...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Track.desc'
        db.delete_column('places_track', 'desc')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Track.desc'
        db.add_column('places_track', 'desc', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
