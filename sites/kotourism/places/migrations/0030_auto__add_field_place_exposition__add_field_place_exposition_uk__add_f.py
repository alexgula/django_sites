...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.exposition'
        db.add_column('places_place', 'exposition', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Place.exposition_uk'
        db.add_column('places_place', 'exposition_uk', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Place.exposition_en'
        db.add_column('places_place', 'exposition_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Place.exposition_ru'
        db.add_column('places_place', 'exposition_ru', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Place.transport'
        db.add_column('places_place', 'transport', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Place.transport_uk'
        db.add_column('places_place', 'transport_uk', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Place.transport_en'
        db.add_column('places_place', 'transport_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Place.transport_ru'
        db.add_column('places_place', 'transport_ru', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Place.exposition'
        db.delete_column('places_place', 'exposition')

        # Deleting field 'Place.exposition_uk'
        db.delete_column('places_place', 'exposition_uk')

        # Deleting field 'Place.exposition_en'
        db.delete_column('places_place', 'exposition_en')

        # Deleting field 'Place.exposition_ru'
        db.delete_column('places_place', 'exposition_ru')

        # Deleting field 'Place.transport'
        db.delete_column('places_place', 'transport')

        # Deleting field 'Place.transport_uk'
        db.delete_column('places_place', 'transport_uk')

        # Deleting field 'Place.transport_en'
        db.delete_column('places_place', 'transport_en')

        # Deleting field 'Place.transport_ru'
        db.delete_column('places_place', 'transport_ru')
