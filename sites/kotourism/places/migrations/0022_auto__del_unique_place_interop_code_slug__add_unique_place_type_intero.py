...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Place', fields ['interop_code', 'slug']
        db.delete_unique('places_place', ['interop_code', 'slug'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Place', fields ['interop_code', 'slug']
        db.create_unique('places_place', ['interop_code', 'slug'])
