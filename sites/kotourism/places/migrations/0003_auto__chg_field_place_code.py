...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.code'
        db.alter_column('places_place', 'code', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):

        # Changing field 'Place.code'
        db.alter_column('places_place', 'code', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
