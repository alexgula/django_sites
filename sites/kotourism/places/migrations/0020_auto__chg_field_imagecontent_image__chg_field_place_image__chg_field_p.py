...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('places_region_imagecontent', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=150))

        # Changing field 'Place.image'
        db.alter_column('places_place', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=150))

        # Changing field 'PlaceType.name_ru'
        db.alter_column('places_placetype', 'name_ru', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PlaceType.name'
        db.alter_column('places_placetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'PlaceType.name_uk'
        db.alter_column('places_placetype', 'name_uk', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PlaceType.name_en'
        db.alter_column('places_placetype', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Region.name_ru'
        db.alter_column('places_region', 'name_ru', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Region.name'
        db.alter_column('places_region', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Region.name_en'
        db.alter_column('places_region', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Region.name_uk'
        db.alter_column('places_region', 'name_uk', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Region.icon'
        db.alter_column('places_region', 'icon', self.gf('sorl.thumbnail.fields.ImageField')(max_length=150))


    def backwards(self, orm):

        # Changing field 'ImageContent.image'
        db.alter_column('places_region_imagecontent', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Place.image'
        db.alter_column('places_place', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'PlaceType.name_ru'
        db.alter_column('places_placetype', 'name_ru', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'PlaceType.name'
        db.alter_column('places_placetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PlaceType.name_uk'
        db.alter_column('places_placetype', 'name_uk', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'PlaceType.name_en'
        db.alter_column('places_placetype', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Region.name_ru'
        db.alter_column('places_region', 'name_ru', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Region.name'
        db.alter_column('places_region', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Region.name_en'
        db.alter_column('places_region', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Region.name_uk'
        db.alter_column('places_region', 'name_uk', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Region.icon'
        db.alter_column('places_region', 'icon', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
    ...
    models = {
        'places.imagecontent': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '150'}),
        ...
        'places.place': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '150', 'blank': 'True'}),
        ...
        'places.region': {
            ...
            'desc_ru': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'desc_uk': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'icon': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '150', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'name_ru': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
