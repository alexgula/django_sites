...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.interop_code'
        db.alter_column('places_place', 'interop_code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):

        # Changing field 'Place.interop_code'
        db.alter_column('places_place', 'interop_code', self.gf('django.db.models.fields.CharField')(default='', max_length=20))
