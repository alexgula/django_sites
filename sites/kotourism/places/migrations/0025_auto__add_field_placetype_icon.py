...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceType.icon'
        db.add_column('places_placetype', 'icon', self.gf('sorl.thumbnail.fields.ImageField')(default='', max_length=250, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'PlaceType.icon'
        db.delete_column('places_placetype', 'icon')
