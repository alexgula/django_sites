...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('places_region_imagecontent', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=250))

        # Changing field 'Place.image'
        db.alter_column('places_place', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=250))

        # Changing field 'Region.icon'
        db.alter_column('places_region', 'icon', self.gf('sorl.thumbnail.fields.ImageField')(max_length=250))
