...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Region.map_id'
        db.add_column('places_region', 'map_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Region.map_color'
        db.add_column('places_region', 'map_color', self.gf('django.db.models.fields.CharField')(default='', max_length=12, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Region.map_id'
        db.delete_column('places_region', 'map_id')

        # Deleting field 'Region.map_color'
        db.delete_column('places_region', 'map_color')
