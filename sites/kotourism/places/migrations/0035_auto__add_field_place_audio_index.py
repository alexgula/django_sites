...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.audio_index'
        db.add_column('places_place', 'audio_index',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Place.audio_index'
        db.delete_column('places_place', 'audio_index')
    ...
    models = {
        ...
        'places.place': {
            ...
            'audio_index': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
