...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('places_place', 'code')

        # Adding field 'Place.interop_code'
        db.add_column('places_place', 'interop_code', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):

        # Adding field 'Place.code'
        db.add_column('places_place', 'code', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True), keep_default=False)

        # Deleting field 'Place.interop_code'
        db.delete_column('places_place', 'interop_code')
