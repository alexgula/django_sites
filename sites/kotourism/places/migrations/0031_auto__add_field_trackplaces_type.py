...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrackPlaces.type'
        db.add_column('places_trackplaces', 'type', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'TrackPlaces.type'
        db.delete_column('places_trackplaces', 'type')
