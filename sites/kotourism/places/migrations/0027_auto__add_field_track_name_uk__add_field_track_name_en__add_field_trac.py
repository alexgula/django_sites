...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Track.name_uk'
        db.add_column('places_track', 'name_uk', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=150, null=True, blank=True), keep_default=False)

        # Adding field 'Track.name_en'
        db.add_column('places_track', 'name_en', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=150, null=True, blank=True), keep_default=False)

        # Adding field 'Track.name_ru'
        db.add_column('places_track', 'name_ru', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=150, null=True, blank=True), keep_default=False)

        # Adding field 'Track.track_uk'
        db.add_column('places_track', 'track_uk', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Track.track_en'
        db.add_column('places_track', 'track_en', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Track.track_ru'
        db.add_column('places_track', 'track_ru', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Track.desc_uk'
        db.add_column('places_track', 'desc_uk', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Track.desc_en'
        db.add_column('places_track', 'desc_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Track.desc_ru'
        db.add_column('places_track', 'desc_ru', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Track.image_desc'
        db.add_column('places_track', 'image_desc', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=250, blank=True), keep_default=False)

        # Adding field 'Track.image_track'
        db.add_column('places_track', 'image_track', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=250, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Track.name_uk'
        db.delete_column('places_track', 'name_uk')

        # Deleting field 'Track.name_en'
        db.delete_column('places_track', 'name_en')

        # Deleting field 'Track.name_ru'
        db.delete_column('places_track', 'name_ru')

        # Deleting field 'Track.track_uk'
        db.delete_column('places_track', 'track_uk')

        # Deleting field 'Track.track_en'
        db.delete_column('places_track', 'track_en')

        # Deleting field 'Track.track_ru'
        db.delete_column('places_track', 'track_ru')

        # Deleting field 'Track.desc_uk'
        db.delete_column('places_track', 'desc_uk')

        # Deleting field 'Track.desc_en'
        db.delete_column('places_track', 'desc_en')

        # Deleting field 'Track.desc_ru'
        db.delete_column('places_track', 'desc_ru')

        # Deleting field 'Track.image_desc'
        db.delete_column('places_track', 'image_desc')

        # Deleting field 'Track.image_track'
        db.delete_column('places_track', 'image_track')
    ...
    models = {
        ...
        'places.track': {
            ...
            'name_ru': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'name_uk': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'places': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['places.Place']", 'symmetrical': 'False', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
