...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Region.icon'
        db.add_column('places_region', 'icon', self.gf('sorl.thumbnail.fields.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Region.icon'
        db.delete_column('places_region', 'icon')
