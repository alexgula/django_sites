...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.date_active_from'
        db.add_column('events_event', 'date_active_from', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Event.date_active_from'
        db.delete_column('events_event', 'date_active_from')

    models = {
        'events.event': {
            'Meta': {'ordering': "['-post_date']", 'unique_together': "(('type', 'date_from', 'slug'),)", 'object_name': 'Event'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'date_active_from': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
