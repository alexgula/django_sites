...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExhibitPartner.order'
        db.add_column('exhibit_exhibitpartner', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ExhibitPartner.order'
        db.delete_column('exhibit_exhibitpartner', 'order')
