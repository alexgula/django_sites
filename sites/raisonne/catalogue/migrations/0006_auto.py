...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Work', fields ['is_listed']
        db.create_index('catalogue_work', ['is_listed'])

        # Adding index on 'Author', fields ['is_listed']
        db.create_index('catalogue_author', ['is_listed'])

    def backwards(self, orm):

        # Removing index on 'Author', fields ['is_listed']
        db.delete_index('catalogue_author', ['is_listed'])

        # Removing index on 'Work', fields ['is_listed']
        db.delete_index('catalogue_work', ['is_listed'])
