...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LifePeriod.slug'
        db.add_column('catalogue_lifeperiod', 'slug', self.gf('django.db.models.fields.SlugField')(default=datetime.date(2011, 1, 10), max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'LifePeriod.slug'
        db.delete_column('catalogue_lifeperiod', 'slug')
