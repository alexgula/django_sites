...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Author.is_listed'
        db.add_column('catalogue_author', 'is_listed', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Author.is_listed'
        db.delete_column('catalogue_author', 'is_listed')
    ...
    models = {
        ...
        'catalogue.work': {
            'Meta': {'ordering': "['-pub_date']", 'unique_together': "(('author', 'slug'),)", 'object_name': 'Work', '_ormbases': ['catalogue.FacetModel']},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Author']"}),
            'desc': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'desc_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'desc_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
