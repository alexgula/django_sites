...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Work.is_listed'
        db.add_column('catalogue_work', 'is_listed', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'Work.pub_date'
        db.alter_column('catalogue_work', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Deleting field 'Work.is_listed'
        db.delete_column('catalogue_work', 'is_listed')

        # Changing field 'Work.pub_date'
        db.alter_column('catalogue_work', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        'catalogue.work': {
            'Meta': {'ordering': "['-pub_date', '-id']", 'unique_together': "(('author', 'slug'),)", 'object_name': 'Work', '_ormbases': ['catalogue.FacetModel']},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Author']"}),
            'desc': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'desc_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'desc_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
