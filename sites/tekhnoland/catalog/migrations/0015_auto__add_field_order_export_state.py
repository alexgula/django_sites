...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.export_state'
        db.add_column('catalog_order', 'export_state', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Order.export_state'
        db.delete_column('catalog_order', 'export_state')
