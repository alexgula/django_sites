...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'OrderItem', fields ['code']
        db.delete_unique('catalog_orderitem', ['code'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'OrderItem', fields ['code']
        db.create_unique('catalog_orderitem', ['code'])
    ...
    models = {
        ...
        'catalog.orderitem': {
            'Meta': {'unique_together': "(('order', 'code'),)", 'object_name': 'OrderItem'},
