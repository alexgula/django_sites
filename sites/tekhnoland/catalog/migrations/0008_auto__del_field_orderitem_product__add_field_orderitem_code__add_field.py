...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('catalog_orderitem', 'product_id')

        # Adding field 'OrderItem.code'
        db.add_column('catalog_orderitem', 'code', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=36), keep_default=False)

        # Adding field 'OrderItem.part_number'
        db.add_column('catalog_orderitem', 'part_number', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)

        # Adding field 'OrderItem.name'
        db.add_column('catalog_orderitem', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Changing field 'OrderItem.pending'
        db.alter_column('catalog_orderitem', 'pending', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ProductStockUnit.pending'
        db.alter_column('catalog_productstockunit', 'pending', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OrderItem.product'
        raise RuntimeError("Cannot reverse this migration. 'OrderItem.product' and its values cannot be restored.")

        # Deleting field 'OrderItem.code'
        db.delete_column('catalog_orderitem', 'code')

        # Deleting field 'OrderItem.part_number'
        db.delete_column('catalog_orderitem', 'part_number')

        # Deleting field 'OrderItem.name'
        db.delete_column('catalog_orderitem', 'name')

        # Changing field 'OrderItem.pending'
        db.alter_column('catalog_orderitem', 'pending', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ProductStockUnit.pending'
        db.alter_column('catalog_productstockunit', 'pending', self.gf('django.db.models.fields.DateField')(null=True))
