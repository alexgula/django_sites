...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'BasketItem.active' to 'BasketItem.selected'
        db.rename_column('catalog_basketitem', 'active', 'selected')

    def backwards(self, orm):

        # Rename field 'BasketItem.selected' to 'BasketItem.active'
        db.rename_column('catalog_basketitem', 'selected', 'active')
