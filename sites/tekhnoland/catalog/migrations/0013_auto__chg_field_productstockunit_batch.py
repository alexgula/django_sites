...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductStockUnit.batch'
        db.alter_column('catalog_productstockunit', 'batch', self.gf('django.db.models.fields.CharField')(default='', max_length=36))

    def backwards(self, orm):

        # Changing field 'ProductStockUnit.batch'
        db.alter_column('catalog_productstockunit', 'batch', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))
