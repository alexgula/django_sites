...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductStockUnit.quantity_reserved'
        db.add_column('catalog_productstockunit', 'quantity_reserved', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'ProductStockUnit.quantity_reserved'
        db.delete_column('catalog_productstockunit', 'quantity_reserved')
    ...
    models = {
        ...
        'catalog.productstockunit': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '4'}),
            'quantity_reserved': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '16', 'decimal_places': '4'}),
            'stock': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
