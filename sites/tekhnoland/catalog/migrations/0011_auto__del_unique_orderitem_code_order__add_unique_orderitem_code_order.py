...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'OrderItem', fields ['code', 'order']
        db.delete_unique('catalog_orderitem', ['code', 'order_id'])

        # Adding unique constraint on 'OrderItem', fields ['code', 'order', 'stock']
        db.create_unique('catalog_orderitem', ['code', 'order_id', 'stock'])

    def backwards(self, orm):

        # Removing unique constraint on 'OrderItem', fields ['code', 'order', 'stock']
        db.delete_unique('catalog_orderitem', ['code', 'order_id', 'stock'])

        # Adding unique constraint on 'OrderItem', fields ['code', 'order']
        db.create_unique('catalog_orderitem', ['code', 'order_id'])
