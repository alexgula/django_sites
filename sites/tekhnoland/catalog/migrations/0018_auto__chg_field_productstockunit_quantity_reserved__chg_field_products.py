...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProductStockUnit.quantity_reserved'
        db.alter_column('catalog_productstockunit', 'quantity_reserved', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ProductStockUnit.quantity'
        db.alter_column('catalog_productstockunit', 'quantity', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'auth.group': {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 25, 1, 10, 1, 595000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 25, 1, 10, 1, 595000)'}),
