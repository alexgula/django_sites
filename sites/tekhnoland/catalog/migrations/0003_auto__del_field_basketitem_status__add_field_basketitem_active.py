...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BasketItem.status'
        db.delete_column('catalog_basketitem', 'status')

        # Adding field 'BasketItem.active'
        db.add_column('catalog_basketitem', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):

        # Adding field 'BasketItem.status'
        db.add_column('catalog_basketitem', 'status', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'BasketItem.active'
        db.delete_column('catalog_basketitem', 'active')
