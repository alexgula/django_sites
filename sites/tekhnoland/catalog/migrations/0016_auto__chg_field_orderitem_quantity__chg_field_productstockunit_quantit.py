...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalog_orderitem', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ProductStockUnit.quantity_reserved'
        db.alter_column('catalog_productstockunit', 'quantity_reserved', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ProductStockUnit.quantity'
        db.alter_column('catalog_productstockunit', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'OrderItem.quantity'
        db.alter_column('catalog_orderitem', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=4))

        # Changing field 'ProductStockUnit.quantity_reserved'
        db.alter_column('catalog_productstockunit', 'quantity_reserved', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=4))

        # Changing field 'ProductStockUnit.quantity'
        db.alter_column('catalog_productstockunit', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=4))
    ...
    models = {
        ...
        'catalog.order': {
            ...
            'export_state': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'catalog.productstockunit': {
            ...
            'batch': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'load_state': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pending': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'quantity_reserved': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'stock': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
