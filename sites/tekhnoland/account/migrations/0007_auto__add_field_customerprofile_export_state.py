...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomerProfile.export_state'
        db.add_column('account_customerprofile', 'export_state', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'CustomerProfile.export_state'
        db.delete_column('account_customerprofile', 'export_state')
