...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerProfile.username1c'
        db.alter_column('account_customerprofile', 'username1c', self.gf('django.db.models.fields.CharField')(unique=True, max_length=120))

    def backwards(self, orm):

        # Changing field 'CustomerProfile.username1c'
        db.alter_column('account_customerprofile', 'username1c', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
