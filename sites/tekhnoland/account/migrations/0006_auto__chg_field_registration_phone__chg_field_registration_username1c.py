...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Registration.phone'
        db.alter_column('account_registration', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Registration.username1c'
        db.alter_column('account_registration', 'username1c', self.gf('django.db.models.fields.CharField')(unique=True, max_length=120))

    def backwards(self, orm):

        # Changing field 'Registration.phone'
        db.alter_column('account_registration', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Registration.username1c'
        db.alter_column('account_registration', 'username1c', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
    ...
    models = {
        'account.customerprofile': {
            ...
            'username1c': ('django.db.models.fields.CharField', [], {'max_length': '120'})
        },
