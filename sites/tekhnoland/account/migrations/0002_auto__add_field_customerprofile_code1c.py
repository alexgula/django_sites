...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomerProfile.code1c'
        db.add_column('account_customerprofile', 'code1c', self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'CustomerProfile.code1c'
        db.delete_column('account_customerprofile', 'code1c')
