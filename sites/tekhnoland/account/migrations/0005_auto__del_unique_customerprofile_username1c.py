...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'CustomerProfile', fields ['username1c']
        db.delete_unique('account_customerprofile', ['username1c'])

    def backwards(self, orm):

        # Adding unique constraint on 'CustomerProfile', fields ['username1c']
        db.create_unique('account_customerprofile', ['username1c'])
