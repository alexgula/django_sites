...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.interop_id'
        db.add_column(u'catalog_category', 'interop_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Category.interop_id'
        db.delete_column(u'catalog_category', 'interop_id')
    ...
    models = {
        u'catalog.category': {
            ...
            'interop_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
