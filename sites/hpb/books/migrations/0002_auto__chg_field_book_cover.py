...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('books_book', 'cover', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Book.cover'
        db.alter_column('books_book', 'cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
